...
Route::get('/sendsms', 'AffiliatesController@sendsms')->middleware('auth');

Route::post('/sendsmspost', 'AffiliatesController@sendsmspost')->middleware('auth');

Route::get('/forex-package/{id}', 'AffiliatesController@packages')->middleware('auth');

Route::get('/deposit', 'AffiliatesController@deposit')->middleware('auth');

Route::get('/loan', 'AffiliatesController@softloan')->middleware('auth');

Route::post('/applyloan', 'AffiliatesController@applyloan')->middleware('auth');

Route::get('/airtime', 'AffiliatesController@airtime')->middleware('auth');

Route::get('/blog', 'AffiliatesController@blog')->middleware('auth');

Route::get('/approve/{id}', 'AffiliatesController@approveblog')->middleware('auth');

Route::get('/ban/{id}', 'AffiliatesController@banuser')->middleware('auth');

Route::get('/unban/{id}', 'AffiliatesController@unbanuser')->middleware('auth');



Route::get('/activate/{id}', 'AffiliatesController@activateuser')->middleware('auth');

Route::get('user/edit/{id}', 'AffiliatesController@edituser')->middleware('auth');

Route::get('user/delete/{id}', 'AffiliatesController@deleteuser')->middleware('auth');

Route::post('update', 'AffiliatesController@updateuser')->middleware('auth');

Route::get('/active', 'AffiliatesController@active')->middleware('auth');

Route::get('/inactive', 'AffiliatesController@inactive')->middleware('auth');

Route::get('/depos', 'AffiliatesController@depos')->middleware('auth');

Route::get('/withs', 'AffiliatesController@withs')->middleware('auth');

Route::post('/blogpost', 'AffiliatesController@blogpost')->middleware('auth');

Route::post('/purchase', 'AffiliatesController@purchase')->middleware('auth');

Route::post('/payforex', 'AffiliatesController@payforex')->middleware('auth');

Route::post('/v1/request', 'ApiController@postdatahaha')->middleware('auth');

Route::post('/withdraw', 'AffiliatesController@with')->middleware('auth');
...
Route::get('/{username}/dashboard', 'HomeController@index')->middleware('auth');


Route::get('/packages', 'AffiliatesController@showpackages')->middleware('auth');
Route::get('/withdraw', 'AffiliatesController@withdraw')->middleware('auth');
Route::post('/ref/withdraw', 'AffiliatesController@withdrawref')->middleware('auth');
Route::post('/inv/withdraw', 'AffiliatesController@withdrawinv')->middleware('auth');
Route::post('/wallet/withdraw', 'AffiliatesController@withdrawwal')->middleware('auth');
...
Route::post('/reseting/password', 'PasswordController@resetPassword');
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////  admin /////////////////////////////////////////////////////////////////////
