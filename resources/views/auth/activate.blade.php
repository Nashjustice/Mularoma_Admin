                                            ...
                                            <div class="card-sigin">
                                                ...
                                                <div class="main-signup-header">
                                                    ...
                                                    <form method="POST" action="{{url('/stkpush')}}">
                                                        ...
                                                        <h5>For account activation Ksh.{{env('Activation_amount')}} is required</h5>                                             
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="hidden" value="{{env('Activation_amount')}}" name="amount">
